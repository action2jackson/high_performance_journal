...
if (window.location.pathname == "/") {
  ...
  if (isMobile == false) {
    window.addEventListener('scroll', function(e) {
      ...
      // Checks if window was resized and if it was then disable parallax
      $(function() {
        ...
        theWindow.resize(check);
        
        function check() {
        
          theWindow.off('scroll.parallax');
        
          if (theWindow.width() > 1300) theWindow.on('scroll.parallax', parallaxStart);
        }
